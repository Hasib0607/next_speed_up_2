import { FORTY_EIGHT, FORTY_FIVE, FORTY_FOUR, FORTY_SEVEN, FORTY_THREE } from '@/consts';
...
export const footers: any = {
    ...
    [FORTY_FOUR]: dynamic(() => import('@/components/footers/footer-fortyfour')),
    [FORTY_FIVE]: dynamic(() => import('@/components/footers/footer-fortyfive')),
    [FORTY_SEVEN]: dynamic(() => import('@/components/footers/footer-fortyseven')),
    [FORTY_EIGHT]: dynamic(() => import('@/components/footers/footer-fortyeight')),
};

...
import AddCartBtnFortyFive from './add-cart-btn-fortyfive';

const DetailsFortyFive = ({
    product,
    children,
    design,
    buttonStyle,
  ...
  `;
    ...
    const buttonEighteen = buttonStyle
        ? buttonStyle
        : 'bg-black btn-hover text-white font-thin sm:py-[10px] py-2 px-5 sm:px-16 w-full';
...
export default DetailsFortyFive;

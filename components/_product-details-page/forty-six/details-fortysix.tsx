...
import AddCartBtn from './add-cart-btn-fortysix';
import { Colors, ColorsOnly, Sizes, Units } from './imageVariations-fortysix';
...
`;
    ...
    const buttonSix =
        'font-bold sm:py-[16px] py-3 w-60 text-center bg-[var(--header-color)] text-[var(--text-color)] rounded-md';
    ...
    return (
        <div className="bg-white h-full ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-10 gap-5">
                ...
                <div className="md:col-span-5 space-y-4 lg:sticky top-28 h-max border p-5 rounded-md">
                    ...
                    <div className="flex justify-start items-center gap-x-10">
                        ...
                        <div className="">
                            <div className="text-[#212121] font-bold flex justify-start items-center gap-4">
                                <BDT />
                                {price}{' '}
                                {save > 0 && (
...
export default DetailsFortySix;

...
const AddCartBtn = ({
    ...
    return (
        <div className="">
            ...
            <div className="flex justify-start items-center gap-x-10 pb-6">
                ...
                {roundedBtn ? (
                    ...
                    <div className="flex border border-gray-300 divide-x-2 w-max">
                        <div
                            className="h-12 w-12  flex justify-center items-center hover:bg-black hover:text-white font-semibold transition-all duration-300 ease-linear cursor-pointer"
                            onClick={decNum}
                        >
                            <MinusIcon width={15} />
                        </div>
                ...
                {button1 && (
                    <button
                        ...
                        className={classNames(
                            buttonOne
                                ? buttonOne
                                : `cart-btn-twenty-one mt-3 font-bold py-[11px] px-10 w-full`,
                            'c_button1'
                        )}
                    >
                        {button1}

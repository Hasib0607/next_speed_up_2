...
const YourOrders = ({
    ...
    return (
        <div>
            <h3 className="font-semibold text-lg uppercase mb-4">Your Order</h3>
            <div className=" border border-gray-200 bg-[#eaedf0]">
                <div className="flex justify-between items-center uppercase font-semibold bg-[#eaedf0] py-4 px-5">
                    <p>Product</p>
                    <p>Subtotal</p>
                </div>
                {cartList ? (
                    <>
                        <div className="bg-white">
                            <div className=" flex flex-col justify-between mt-4 pt-5">
                ...
                <div
                    className="mb-5 pt-5 text-gray-500 px-2"

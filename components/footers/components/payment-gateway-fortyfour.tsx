...
const PaymantGatewayFortyFour = ({ headersetting }: any) => {
    ...
    return (
        <div className={`flex flex-col md:flex-row gap-10 ${isAnyPaymentActive ? 'justify-between' : 'justify-center md:justify-center'}`}>
            {isAnyPaymentActive && (
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 md:w-1/2">
            ...
            <div className='flex flex-col items-center'>
                <FaRegFaceSmile />
                <h2 className='text-xl font-semibold mb-5'>Satisfaction guaranteed</h2>
                <p className='text-[16px]'>Made with premium quality materials.</p>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='font-semibold'>Tracked delivery with premium carriers</p>
            </div>
        </div>
    );
};

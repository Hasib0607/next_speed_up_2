...
const HeaderThirty = ({ headersetting, design, user, menu }: any) => {
        ...
        <div>
            ...
            <div className="">
                ...
                <div className="flex justify-between items-center sm:container px-5 pt-3 pb-3 lg:pb-3">
                    ...
                    <div className="relative md:flex hidden items-center justify-between w-full border lg:mx-20 md:mx-3">
                        <p

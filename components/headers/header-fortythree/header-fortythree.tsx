...
import MenuFortyThree from './menu-fortythree';
import SideMenuFortyThree from './side-menu-fortythree';

const HeaderFortyThree = ({ design, headersetting, menu }: any) => {
                ...
                <div className="flex flex-col lg:flex-row justify-between items-center nav-menu sm:container px-5 py-5 gap-3 lg:gap-0">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            >
                                <BsFillCartFill className="text-3xl font-thin" />
                                <p
                                    style={{
...
export default HeaderFortyThree;

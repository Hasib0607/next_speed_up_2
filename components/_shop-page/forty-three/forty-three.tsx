...
import FilterByColorFortyThree from './filter-by-color-fortythree';
import FilterByPriceFortyThree from './filter-by-price-fortythree';
import BestSellerFortyThreeForShop from './best-sell-fortythree-for-shop';
import { LuSettings2 } from 'react-icons/lu';
import { FiX } from 'react-icons/fi';
import CustomMenu from './custom-menu';

const FortyThree = ({ design, store_id }: any) => {
    const module_id = 105;
 ...
 `;
    ...
    return (
        <div>
            <ShopBreadcrumb title={'Collection'} subTitle={'Collections'} />

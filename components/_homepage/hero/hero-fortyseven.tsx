        ...
        >
          {slider?.map((s: any) => (
            <SwiperSlide key={s.id}>
                ...
                >
                  ...
                  {s?.link && (
                    <a href={s?.link} target="_blank" rel="noopener noreferrer">
                      <h1
                        className={`px-6 md:py-2 py-1 btn-slider duration-300 lg:text-lg text-xs sm:text-center w-max md:mx-auto lg:cursor-pointer bg-black text-white rounded-full font-medium ${
              ...
              <div className="">
                  <div className="backdrop-blur w-96 h-full absolute left-0 ">jj</div>
                <img
